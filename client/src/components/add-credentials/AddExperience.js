				...
				<div className="container">
					<div className="row">
						<div className="col-md-8 m-auto">
							...
							<p className="lead text-center">Add any job or position which you've had in the past or which is in progress</p>
							...
							<form onSubmit={this.onSubmit}>
								...
								<TextAreaFieldGroup
									...
									info="Tell us a little bit about the job position"
								/>
								<input 
									type="submit" 
									value="Submit" 
